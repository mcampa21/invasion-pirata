...
function preload() {
  ...
  sonidoF = loadSound("assets/background_music.mp3");
  explosion = loadSound("assets/cannon_explosion.mp3");
  sonidoA = loadSound("assets/cannon_water.mp3");
  risa = loadSound("assets/pirate_laugh.mp3");
}
